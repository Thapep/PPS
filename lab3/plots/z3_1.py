...
plt.title("Throughput for Size: 1024 and Workload: 80/10/10")
lgd = plt.legend()

lgd.draw_frame(False)
plt.savefig("ex3_thoughput_1024_1.png", bbox_inches="tight")
...
plt.title("Throughput for Size: 8192 and Workload: 80/10/10")
lgd = plt.legend()

lgd.draw_frame(False)
plt.savefig("ex3_thoughput_8192_1.png", bbox_inches="tight")
